...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-healthcare-50 via-white to-blue-50">
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-block bg-healthcare-100 text-healthcare-700 px-4 py-2 rounded-full text-sm font-bold">
                  ✨ Powered by Advanced AI
                </div>
                <h1 className="text-5xl lg:text-6xl font-black text-healthcare-900 leading-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link 
                  href="#features" 
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-white border-2 border-healthcare-500 px-8 py-4 text-healthcare-600 font-bold hover:bg-healthcare-50 transition-all"
                >
                  📖 Learn More
                </Link>
              </div>
              ...
              <div className="flex gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700"><strong>24/7</strong> Available</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl">🔒</span>
                  <span className="text-gray-700"><strong>100%</strong> Secure</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl">⚡</span>
                  <span className="text-gray-700"><strong>Instant</strong> Guidance</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative hidden lg:flex items-center justify-center">
              <div className="relative w-full h-full max-w-md">
                ...
                <div className="relative bg-gradient-to-br from-healthcare-100 to-blue-50 rounded-3xl p-8 border-2 border-healthcare-200 shadow-2xl">
                  <div className="space-y-4">
      ...
      <section id="features" className="py-24 px-6">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl lg:text-5xl font-black text-healthcare-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature Card 1 */}
            <div className="group bg-white rounded-2xl p-8 border-2 border-healthcare-100 hover:border-healthcare-500 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="text-5xl mb-4 transform group-hover:scale-125 transition-transform">🩺</div>
              <h3 className="text-2xl font-bold text-healthcare-800 mb-3">AI Symptom Analysis</h3>
            ...
            <div className="group bg-white rounded-2xl p-8 border-2 border-healthcare-100 hover:border-healthcare-500 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-healthcare-800 mb-3">Doctor Appointments</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-8 border-2 border-healthcare-100 hover:border-healthcare-500 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="text-5xl mb-4 transform group-hover:scale-125 transition-transform">🔒</div>
              <h3 className="text-2xl font-bold text-healthcare-800 mb-3">Privacy Protected</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-8 border-2 border-healthcare-100 hover:border-healthcare-500 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="text-5xl mb-4 transform group-hover:scale-125 transition-transform">⚡</div>
              <h3 className="text-2xl font-bold text-healthcare-800 mb-3">Instant Response</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-8 border-2 border-healthcare-100 hover:border-healthcare-500 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="text-5xl mb-4 transform group-hover:scale-125 transition-transform">📚</div>
              <h3 className="text-2xl font-bold text-healthcare-800 mb-3">Medical Knowledge Base</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-8 border-2 border-healthcare-100 hover:border-healthcare-500 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="text-5xl mb-4 transform group-hover:scale-125 transition-transform">📱</div>
              <h3 className="text-2xl font-bold text-healthcare-800 mb-3">Easy to Use</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* How It Works */}
      <section className="py-24 px-6 bg-gradient-to-r from-healthcare-50 to-blue-50">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl lg:text-5xl font-black text-healthcare-900">
              How It Works
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="relative">
                ...
                <div className="bg-white rounded-2xl p-8 text-center border-2 border-healthcare-200 relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-healthcare-800 mb-2">{step.title}</h3>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-4xl font-black text-healthcare-900 text-center mb-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={idx} className="bg-white rounded-xl p-6 border-l-4 border-healthcare-500">
                <h3 className="text-lg font-bold text-healthcare-800 mb-2">{faq.q}</h3>
